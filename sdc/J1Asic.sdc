...
set_output_delay 4.8000 -clock [get_clocks {boardClk}] -add_delay [get_ports {pmodA_writeEnable[0]}]
set_output_delay 4.8000 -clock [get_clocks {boardClk}] -add_delay [get_ports {pmodA_writeEnable[1]}]
set_output_delay 4.8000 -clock [get_clocks {boardClk}] -add_delay [get_ports {pmodA_writeEnable[2]}]
set_output_delay 4.8000 -clock [get_clocks {boardClk}] -add_delay [get_ports {pmodA_writeEnable[3]}]
set_output_delay 4.8000 -clock [get_clocks {boardClk}] -add_delay [get_ports {pmodA_writeEnable[4]}]
set_output_delay 4.8000 -clock [get_clocks {boardClk}] -add_delay [get_ports {pmodA_writeEnable[5]}]
set_output_delay 4.8000 -clock [get_clocks {boardClk}] -add_delay [get_ports {pmodA_writeEnable[6]}]
set_output_delay 4.8000 -clock [get_clocks {boardClk}] -add_delay [get_ports {pmodA_writeEnable[7]}]
...
set_load -pin_load 0.0729 [get_ports {pmodA_writeEnable[7]}]
set_load -pin_load 0.0729 [get_ports {pmodA_writeEnable[6]}]
set_load -pin_load 0.0729 [get_ports {pmodA_writeEnable[5]}]
set_load -pin_load 0.0729 [get_ports {pmodA_writeEnable[4]}]
set_load -pin_load 0.0729 [get_ports {pmodA_writeEnable[3]}]
set_load -pin_load 0.0729 [get_ports {pmodA_writeEnable[2]}]
set_load -pin_load 0.0729 [get_ports {pmodA_writeEnable[1]}]
set_load -pin_load 0.0729 [get_ports {pmodA_writeEnable[0]}]
